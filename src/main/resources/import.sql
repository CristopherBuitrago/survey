...
INSERT INTO chapters (component_html, component_react, created_at, number, title, updated_at, survey_id) VALUES ('<div>Chapter HTML for Survey 1</div>', '<ChapterComponent1 />', CURRENT_TIMESTAMP, 1, 'Chapter 1 for Survey 1', CURRENT_TIMESTAMP, 1);

INSERT INTO chapters (component_html, component_react, created_at, number, title, updated_at, survey_id) VALUES ('<div>Chapter HTML for Survey 2</div>', '<ChapterComponent2 />', CURRENT_TIMESTAMP, 1, 'Chapter 1 for Survey 2', CURRENT_TIMESTAMP, 2 );

INSERT INTO chapters (component_html, component_react, created_at, number, title, updated_at, survey_id) VALUES ('<div>Chapter HTML for Survey 3</div>', '<ChapterComponent3 />', CURRENT_TIMESTAMP, 1,'Chapter 1 for Survey 3', CURRENT_TIMESTAMP, 3);
